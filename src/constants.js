...
const MIAMI_CITY = "Miami"
const MIAMI_CLASS = "city-Miami"
const MIAMI_COLOR = "#e67e22"
...
export const HOUSTON = "HOUSTON"
const HOUSTON_CITY = "Houston"
const HOUSTON_CLASS = "city-Houston"
const HOUSTON_COLOR = "#34495e"
...
export const CITIES = {
  SAN_FRANCISCO: { city: SAN_FRANCISCO_CITY, color: SAN_FRANCISCO_COLOR, class: SAN_FRANCISCO_CLASS },
  NEW_YORK: { city: NEW_YORK_CITY, color: NEW_YORK_COLOR, class: NEW_YORK_CLASS },
  BOSTON: { city: BOSTON_CITY, color: BOSTON_COLOR, class: BOSTON_CLASS },
  MIAMI: { city: MIAMI_CITY, color: MIAMI_COLOR, class: MIAMI_CLASS },
  SEATTLE: { city: SEATTLE_CITY, color: SEATTLE_COLOR, class: SEATTLE_CLASS },
  HOUSTON: { city: HOUSTON_CITY, color: HOUSTON_COLOR, class: HOUSTON_CLASS },
  SAN_JOSE: { city: SAN_JOSE_CITY, color: SAN_JOSE_COLOR, class: SAN_JOSE_CLASS },
  RALEIGN: { city: RALEIGN_CITY, color: RALEIGN_COLOR, class: RALEIGN_CLASS },
